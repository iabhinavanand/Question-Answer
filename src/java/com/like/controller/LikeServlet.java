...
import com.unlike.dao.UnlikeDao;
...
public class LikeServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String op = request.getParameter("likeOp");
            ...
            if (op.equals("dolike")) {
                ...
                UnlikeDao dao = new UnlikeDao(ConnectionProvider.getConnection());
                if (dao.doUnlike(pid, userid)) {
                    out.println("Like");
                } else {
                    out.print("error");
